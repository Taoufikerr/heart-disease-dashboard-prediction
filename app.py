...
st.plotly_chart(px.box(filtered_df, x="target", y="chol", color=filtered_df["target"].map({0:"Negative", 1:"Positive"}), title="Cholesterol by Heart Disease", labels={"target": "Heart Disease", "chol": "Cholesterol"}))

# Bar chart of resting ECG
